package xyz.gzzh.leetcode.test2;
...
public class TestLog2 {
    ...
    private final static String BASE_PATH = "src/xyz/gzzh/leetcode/test2/";
    ...
    public void hbOrder() throws IOException {
        ...
        try {
            ...
            while ((order = bufferedReader.readLine()) != null) {
                ...
                //TODO 改数量
                for (int i = 0; i < 12; i++) {
                    orderJson = getOrderJson(order, "gateway.log.2021-07-15." + i);
                    if (orderJson != null) {
                        break;
                    }
                }
    ...
    private static String getOrderJson(String orderId, String fileName) throws IOException {
        ...
        try {
            ...
            while ((lineText = bufferedReader.readLine()) != null) {
                if (lineText.contains(orderId) && (lineText.contains("\"status\":\"CLOSE\"") || lineText.contains("\"status\":\"COMPLETE\""))) {
